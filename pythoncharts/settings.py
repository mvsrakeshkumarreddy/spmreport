...
ALLOWED_HOSTS = ['*','https://web-production-402f.up.railway.app', 'http://www.spmreportautomation.com']
CSRF_TRUSTED_ORIGINS = ['https://web-production-402f.up.railway.app','http://www.spmreportautomation.com']
